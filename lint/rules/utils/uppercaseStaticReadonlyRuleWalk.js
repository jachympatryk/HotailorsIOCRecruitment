...
var UppercaseStaticReadonlyRuleWalk = /** @class */ (function (_super) {
  ...
  UppercaseStaticReadonlyRuleWalk.prototype.shouldNameBeChecked = function (
    node
  ) {
    return this.memberIsStatic(node) && this.memberIsReadonly(node);
  };
  UppercaseStaticReadonlyRuleWalk.prototype.isRelevantClassMember = function (
    node
  ) {
    switch (node.kind) {
